...
<div class="policy  pb-4">
    <div class="policy-header">
        <div class="container-lg">
            <div class="d-flex flex-row align-items-center py-4 justify-content-between">
    ...
    <div class="container-lg">
        ...
        <h1 class="f-bold pt-5 mb-4">Privacy Policy</h1>
        ...
        <p>The words of which the initial letter is capitalized have meanings defined under the following conditions.
            ...
            plural.</p>
        <h3 class="f-bold mt-4 mb-2">Definitions</h3>
        ...
        <ul>
            ...
            <li>
                <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;,
                    &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to AthenianWheels.</p>
            </li>
            <li>
            ...
            <li>
                <p><strong>Website</strong> refers to AthenianWheels, accessible from <a href="www.athenianwheels.com"
                        rel="external nofollow noopener" target="_blank">www.athenianwheels.com</a></p>
            </li>
            <li>
        ...
        <h4 class="f-bold mt-5">Usage Data</h4>
        ...
        <h4 class="f-bold mt-5">Tracking Technologies and Cookies</h4>
        ...
        <h3 class="f-bold mt-5">Use of Your Personal Data</h3>
        ...
        <h3 class="f-bold mt-5">Retention of Your Personal Data</h3>
        ...
        <h3 class="f-bold mt-5">Transfer of Your Personal Data</h3>
        ...
        <h3 class="f-bold mt-5">Delete Your Personal Data</h3>
        ...
        <h4 class="f-bold mt-5">Law enforcement</h4>
        ...
        <h4 class="f-bold mt-5">Other legal requirements</h4>
        ...
        <h2 class="f-bold mt-5">Links to Other Websites</h2>
        ...
        <h2 class="f-bold mt-5">Changes to this Privacy Policy</h2>
        ...
        <h2 class="f-bold mt-5">Contact Us</h2>
        <p>If you have any questions about this Privacy Policy, You can contact us:</p>
        <ul>
            <li>By visiting this page on our website: <a href="AthenianWheels.com" rel="external nofollow noopener"
                    target="_blank">AthenianWheels.com</a></li>
        </ul>
    </div>
</div>
